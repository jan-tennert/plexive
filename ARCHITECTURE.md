...
frontend/
  ...
  src/components/
    ...
    SectionRenderer.tsx         maps section.type → component; handles all sections for books/facts/people/concepts/questions/stories formats; no line dividers (LAYOUT_STANDARD s7: whitespace is the single divider, sections separated by uniform px-6 py-8 rhythm); NO_READ_SECTIONS (at_a_glance/quiz/paper_card/related_posts/sources) wrapped in data-no-read so read-aloud speaks only prose sections
    sections/
