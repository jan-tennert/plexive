...
- Mobile parity gap (mobile/): web facts card + detail now use the full-width banner layout and redesigned detail header (LAYOUT_STANDARD.md); mobile/ PostCard + post/[id] still use the square card anchor and the old slab header — not yet ported
